<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="adminenquires.css">
	...
	<body>
		...
		<ul>
			...
			<li><a class="active" href="">Business Enquires</a></li>
			<li><a href="adminfeedback.php">Feedback</a></li>
			<li><a href="admincustomer.php">Customers</a></li>
		</ul> <br><br>
		<table border="1" id="request">
			<tr>
				<th colspan="6"><font size="5">List of Enquires</font></th>
			</tr>
			<tr>
				<th>Sr no.</th>
				<th>Name</th>
			...
			<?php
				...
				$query = "select * from business_enquires";
