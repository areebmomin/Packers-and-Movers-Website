<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="confirmhousehold.css">
	</head>
	<body>
		<div class="outside">
			...
			<table border="0" align="center" height="20%" width="90%" cellspacing="0px" cellpadding="2px">
				...
				<tr>
					<td align="center">
							<a href="http://localhost:8080/QuickMove/location/householdlocation.php" style="float:left;margin-left:20px;"><button type="button" name="back" class="btn"> &laquo; Back</button></a>
			...
			$_SESSION['servicen1'] = $service;
			$location =  $_POST['location'];
			$destination = $_POST['destination'];
			$conn = mysqli_connect("localhost","root","","quickmove");
			$query = "insert into household_requests value('','$username','$mobile','$service','$location','$destination')";
