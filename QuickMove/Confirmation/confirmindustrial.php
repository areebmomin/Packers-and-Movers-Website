<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="confirmindustrial.css">
	</head>
	<body>
		<div class="outside">
			...
			<table border="0" align="center" height="20%" width="90%" cellspacing="0px" cellpadding="2px">
				...
				<tr>
					<td align="center">
							<a href="http://localhost:8080/QuickMove/location/industriallocation.php" style="float:left;margin-left:20px;"><button type="button" name="feedback" class="btn"> &laquo; Back</button></a>
			...
			$service = $_SESSION['service4'];
			$_SESSION['servicen4'] = $service;
			$location =  $_POST['location'];
			$destination = $_POST['destination'];
			$conn = mysqli_connect("localhost","root","","quickmove");
			$query = "insert into industrial_requests value('','$username','$mobile','$service','$location','$destination')";
